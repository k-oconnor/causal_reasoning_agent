"""
KSP Mun Mission — Attempt 1
3-stage rocket: Reliant (stage 1) → Terrier (stage 2) → Spark (stage 3)
...
def gravity_turn_pitch(altitude):
    ...
    if altitude < 1000:
        ...
        return 10.0  # slight pitch above 45 km
...
try:
    ...
    while True:
        ...
        if alt > 68000 and ap_alt < target_ap:
            # Higher throttle to push apoapsis out
            vessel.control.throttle = 1.0
